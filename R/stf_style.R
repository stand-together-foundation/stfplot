#' Add stf theme to ggplot chart
#'
#' This function allows you to add the stf theme to your ggplotgraphics.
#' @keywords stf_style
#' @export
#' @examples
...
stf_style <- function() {
  ...
  plot.subtitle = ggplot2::element_text(family='Graphik Light',
                               size=22,
                               color="#323E48",
                               face="bold",
